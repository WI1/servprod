...
function servprod_print_terms($node) {
       ...
       if ($vocabularies) {
         ...
         if ($terms) {
           ...
           foreach ($terms as $term) {
             $links[] = l($term->name, servprod_term_path($term), array('rel' => 'tag', 'title' => strip_tags($term->description)));
           }
...
function servprod_breadcrumb($breadcrumb) {  
...
*/
function servprod_preprocess_headerimage_block(&$variables) {
  $node = $variables['node'];
